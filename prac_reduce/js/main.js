...
const voted = people.filter( (peopleWhoVote) => {
    return peopleWhoVote.voted === true
})

console.log(voted)


const avergeAge = people.age.reduce((acumulador, valorActual) => {
    return (acumulador + valorActual) / people.length
})
